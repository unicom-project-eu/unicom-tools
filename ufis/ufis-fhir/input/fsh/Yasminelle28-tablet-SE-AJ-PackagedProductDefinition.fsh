...
* packaging.packaging.containedItem[+].item.reference.reference = "ManufacturedItemDefinition/Yasminelle28-tablet-SE-AJ-ManufacturedItemDefinition01"
* packaging.packaging.containedItem[=].amount.value = 21
...
* packaging.packaging.containedItem[+].item.reference.reference = "ManufacturedItemDefinition/Yasminelle28-tablet-SE-AJ-ManufacturedItemDefinition02"
