...
* packaging.packaging.type.coding.code = #100000073550
* packaging.packaging.type.coding.display = "Single-dose container"
...
* packaging.packaging.containedItem.item.reference.reference = "ManufacturedItemDefinition/Tapin-2525-Plaster-SE-AJ-ManufacturedItemDefinition"
* packaging.packaging.containedItem.amount.value = 1
* packaging.packaging.containedItem.amount.code = #200000002140
* packaging.packaging.containedItem.amount.system = "http://spor.ema.europa.eu/v1/lists/200000000014"
* packaging.packaging.containedItem.amount.unit = "plaster"