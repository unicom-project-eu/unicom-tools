...
* packaging.packaging.packaging.type.coding.code = #200000002158
...
* packaging.packaging.packaging.containedItem.item.reference.reference = "ManufacturedItemDefinition/Zinacef-1.5g-Powder-SE-IS-ManufacturedItemDefinition"
