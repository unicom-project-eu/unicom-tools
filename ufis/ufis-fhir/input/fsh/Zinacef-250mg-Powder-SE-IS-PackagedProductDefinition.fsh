...
* packaging.packaging.packaging.type.coding.code = #100000073563
* packaging.packaging.packaging.type.coding.display = "Vial"
...
* packaging.packaging.packaging.containedItem.item.reference.reference = "ManufacturedItemDefinition/Zinacef-250mg-Powder-SE-IS-ManufacturedItemDefinition"
* packaging.packaging.packaging.containedItem.amount.value = 1
* packaging.packaging.packaging.containedItem.amount.code = #200000002158
* packaging.packaging.packaging.containedItem.amount.system = "http://spor.ema.europa.eu/v1/lists/200000000014"
* packaging.packaging.packaging.containedItem.amount.unit = "Vial"