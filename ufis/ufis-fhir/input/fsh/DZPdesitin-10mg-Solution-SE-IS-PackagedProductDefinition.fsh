...
* packaging.packaging.type.coding.display = "Bag"
...
* packaging.packaging.packaging.type.coding.code = #100000073542
* packaging.packaging.packaging.type.coding.display = "Pre-filled gastroenteral tube"
...
* packaging.packaging.packaging.containedItem.item.reference.reference = "ManufacturedItemDefinition/DZPdesitin-10mg-Solution-SE-IS-ManufacturedItemDefinition"
...
* packaging.packaging.packaging.containedItem.amount.unit = "Tube"