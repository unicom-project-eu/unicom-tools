...
* packaging.packaging[=].type.coding.code = #100000073554
* packaging.packaging[=].type.coding.display = "Spray pump"
...
* packaging.packaging[=].containedItem.item.reference.reference = "ManufacturedItemDefinition/Xylocain-100mgml-cutspray-SE-AJ-ManufacturedItemDefinition"
