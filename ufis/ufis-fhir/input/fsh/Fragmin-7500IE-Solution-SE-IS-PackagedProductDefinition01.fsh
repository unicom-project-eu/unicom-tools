...
* packaging.packaging.packaging.containedItem.item.reference.reference = "ManufacturedItemDefinition/Fragmin-7500IE-Solution-SE-IS-ManufacturedItemDefinition"
