...
* packaging.packaging.containedItem.item.reference.reference = "ManufacturedItemDefinition/EnoxaparinLedraxen2000IEinjektion-SE-PLC-ManufacturedItemDef"
* packaging.packaging.containedItem.amount.value = 0.2
