...
* packaging.packaging.packaging.containedItem.item.reference.reference = "ManufacturedItemDefinition/Sendolor-1mgml-Solution-SE-BS-ManufacturedItemDefinition"
