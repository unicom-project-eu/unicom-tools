...
* containedItemQuantity = 330 http://spor.ema.europa.eu/v1/lists/200000000014#200000002152 "Tablet"
...
* packaging.packaging.containedItem.item.reference.reference = "ManufacturedItemDefinition/MetforminSandoz-500mg-Tablet-SE-BS-ManufacturedItemDefinition"
* packaging.packaging.containedItem.amount.value = 330
