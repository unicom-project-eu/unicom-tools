...
* packaging.packaging.material.coding.code = #200000003206
* packaging.packaging.material.coding.display = "Glass type III"
* packaging.packaging.containedItem.item.reference.reference = "ManufacturedItemDefinition/SandimmunNeoral100mgmlorallos-SE-PLC-ManufacturedItemDef"
