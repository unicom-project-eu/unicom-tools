...
* packaging.packaging.containedItem.item.reference.reference = "ManufacturedItemDefinition/Tiparol50mgbrustablett-SE-PLC-ManufacturedItemDef"
* packaging.packaging.containedItem.amount.value = 15
