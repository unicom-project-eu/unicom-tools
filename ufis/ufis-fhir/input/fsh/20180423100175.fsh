...
* packaging.packaging[=].material.coding.system = "https://spor.ema.europa.eu/v1/lists/200000003199"
* packaging.packaging[=].material.coding.code = #XXX
* packaging.packaging[=].material.coding.display = "Glass"
* packaging.packaging[=].containedItem.item.reference.reference = "ManufacturedItemDefinition/hevicain5-SE-ManItem001"
