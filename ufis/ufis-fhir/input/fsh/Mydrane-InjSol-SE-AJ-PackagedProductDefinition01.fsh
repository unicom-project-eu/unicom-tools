...
* packaging.packaging.packaging.containedItem.item.reference.reference = "ManufacturedItemDefinition/Mydrane-InjSol-SE-AJ-ManufacturedItemDefinition"
* packaging.packaging.packaging.containedItem.amount.value = 0.6
