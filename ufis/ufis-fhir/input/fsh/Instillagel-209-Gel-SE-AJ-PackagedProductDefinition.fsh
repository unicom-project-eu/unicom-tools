...
* packaging.packaging.packaging.containedItem.item.reference.reference = "ManufacturedItemDefinition/Instillagel-209-Gel-SE-AJ-ManufacturedItemDefinition"
* packaging.packaging.packaging.containedItem.amount.value = 11
