...
* packaging.packaging.packaging.containedItem.item.reference.reference = "ManufacturedItemDefinition/Stesolid-5mg-Solution-SE-IS-ManufacturedItemDefinition"
