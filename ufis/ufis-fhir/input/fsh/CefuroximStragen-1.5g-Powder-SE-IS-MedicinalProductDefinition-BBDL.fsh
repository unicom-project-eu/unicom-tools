Instance: CefuroximStragen-1.5g-Powder-SE-IS-MedicinalProductDefinition-BBDL
InstanceOf: Bundle
Usage: #example
* type = #transaction
* entry[+].resource = CefuroximStragen-1.5g-Powder-SE-IS-MedicinalProductDefinition
