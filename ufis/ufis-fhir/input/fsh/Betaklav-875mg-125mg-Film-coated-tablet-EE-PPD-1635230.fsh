...
* description = "Ribapakend (Al/Al) 14 õhukese polümeerikattega tabletti karbis"
...
* packaging.packaging.containedItem.item.reference.reference = "ManufacturedItemDefinition/Betaklav-875mg-125mg-Film-coated-tablet-EE-MID"
