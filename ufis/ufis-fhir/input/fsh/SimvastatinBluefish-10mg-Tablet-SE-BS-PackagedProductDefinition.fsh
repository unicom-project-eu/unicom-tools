...
* packaging.packaging.containedItem.item.reference.reference = "ManufacturedItemDefinition/SimvastatinBluefish-10mg-Tablet-SE-BS-ManufacturedItemDefinition"
