...
* packaging.packaging.quantity = 25
...
* packaging.packaging.containedItem.item.reference.reference = "ManufacturedItemDefinition/SertralinTeva50mgfilmtablett-SE-PLC-ManufacturedItemDef"
