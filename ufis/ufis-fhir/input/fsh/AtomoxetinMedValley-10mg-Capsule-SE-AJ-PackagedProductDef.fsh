...
* packaging.shelfLifeStorage.periodDuration.value = 30
* packaging.shelfLifeStorage.periodDuration.code = #200000003433
...
* packaging.shelfLifeStorage.specialPrecautionsForStorage.coding.code = #100000073424
* packaging.shelfLifeStorage.specialPrecautionsForStorage.coding.display = "This medicinal product does not require any special storage conditions"
...
* packaging.packaging.material[+].coding.system = "https://spor.ema.europa.eu/v1/lists/200000003199"
* packaging.packaging.material[=].coding.code = #200000003209
* packaging.packaging.material[=].coding.display = "PolyAmide"
* packaging.packaging.containedItem.item.reference.reference = "ManufacturedItemDefinition/AtomoxetinMedValley-10mg-Capsule-SE-AJ-ManufacturedItemDef"
