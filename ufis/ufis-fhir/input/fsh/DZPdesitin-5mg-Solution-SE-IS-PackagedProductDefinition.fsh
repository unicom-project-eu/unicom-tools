...
* packaging.packaging.packaging.containedItem.item.reference.reference = "ManufacturedItemDefinition/DZPdesitin-5mg-Solution-SE-IS-ManufacturedItemDefinition"
