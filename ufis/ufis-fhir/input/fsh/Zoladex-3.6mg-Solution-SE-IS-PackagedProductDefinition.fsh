...
* packaging.packaging.packaging.material[=].coding.code = #200000003220
* packaging.packaging.packaging.material[=].coding.display = "PolyStyrene"
* packaging.packaging.packaging.material[+].coding.system = "https://spor.ema.europa.eu/v1/lists/200000003199"
* packaging.packaging.packaging.material[=].coding.code = #200000003215
* packaging.packaging.packaging.material[=].coding.display = "High Density PolyEthylene"
* packaging.packaging.packaging.material[+].coding.system = "https://spor.ema.europa.eu/v1/lists/200000003199"
...
* packaging.packaging.packaging.containedItem.item.reference.reference = "ManufacturedItemDefinition/Zoladex-3.6mg-Solution-SE-IS-ManufacturedItemDefinition"
* packaging.packaging.packaging.containedItem.amount.value = 3.6
...
* packaging.packaging.packaging.containedItem.amount.unit = "milligram(s)/dose"