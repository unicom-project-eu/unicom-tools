...
* packaging.packaging.containedItem.item.reference.reference = "ManufacturedItemDefinition/Xylocain-Dental-Adrenalin-SE-AJ-ManufacturedItemDefinition"
* packaging.packaging.containedItem.amount.value = 1.8
