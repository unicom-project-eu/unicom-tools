...
* packaging.shelfLifeStorage.specialPrecautionsForStorage[+].coding.system = "https://spor.ema.europa.eu/v1/lists/100000073344"
* packaging.shelfLifeStorage.specialPrecautionsForStorage[=].coding.code = #100000073429
* packaging.shelfLifeStorage.specialPrecautionsForStorage[=].coding.display = "Store in the original container"
...
* packaging.packaging.packaging.containedItem.item.reference.reference = "ManufacturedItemDefinition/LidokainAgu-20mgml-InjSol-SE-AJ-ManufacturedItemDefinition"
