...
* packaging.containedItem.item.reference.reference = "ManufacturedItemDefinition/PinexJordgubb250mggranulat-SE-PLC-ManufacturedItemDef"
...
* packaging.containedItem.amount.unit = "Sachet"