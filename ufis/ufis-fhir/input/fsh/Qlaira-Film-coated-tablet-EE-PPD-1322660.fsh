...
* packaging.packaging.containedItem[+].item.reference.reference = "ManufacturedItemDefinition/Qlaira-Film-coated-tablet-EE-MID-dark-yellow"
* packaging.packaging.containedItem[=].amount.value = 2
* packaging.packaging.containedItem[+].item.reference.reference = "ManufacturedItemDefinition/Qlaira-Film-coated-tablet-EE-MID-medium-red"
* packaging.packaging.containedItem[=].amount.value = 5
* packaging.packaging.containedItem[+].item.reference.reference = "ManufacturedItemDefinition/Qlaira-Film-coated-tablet-EE-MID-light-yellow"
* packaging.packaging.containedItem[=].amount.value = 17
* packaging.packaging.containedItem[+].item.reference.reference = "ManufacturedItemDefinition/Qlaira-Film-coated-tablet-EE-MID-dark-red"
* packaging.packaging.containedItem[=].amount.value = 2
* packaging.packaging.containedItem[+].item.reference.reference = "ManufacturedItemDefinition/Qlaira-Film-coated-tablet-EE-MID-white"
* packaging.packaging.containedItem[=].amount.value = 2