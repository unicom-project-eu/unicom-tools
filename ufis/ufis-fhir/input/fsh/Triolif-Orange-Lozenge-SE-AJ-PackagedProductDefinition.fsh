...
* packaging.shelfLifeStorage.periodDuration.value = 27
...
* packaging.packaging.containedItem.item.reference.reference = "ManufacturedItemDefinition/Triolif-Orange-Lozenge-SE-AJ-ManufacturedItemDefinition"
* packaging.packaging.containedItem.amount.value = 12
* packaging.packaging.containedItem.amount.code = #200000002128
* packaging.packaging.containedItem.amount.system = "http://spor.ema.europa.eu/v1/lists/200000000014"
* packaging.packaging.containedItem.amount.unit = "Lozenge"