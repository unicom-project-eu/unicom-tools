...
* packaging.packaging.packaging.containedItem.item.reference.reference = "ManufacturedItemDefinition/Fragmin-2500IE-Solution-SE-IS-ManufacturedItemDefinition"
