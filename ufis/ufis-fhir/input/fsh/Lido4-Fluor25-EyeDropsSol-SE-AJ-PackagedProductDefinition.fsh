...
* packaging.shelfLifeStorage.periodDuration.value = 15
...
* packaging.packaging.packaging.type.coding.code = #100000073550
* packaging.packaging.packaging.type.coding.display = "Single-dose container"
