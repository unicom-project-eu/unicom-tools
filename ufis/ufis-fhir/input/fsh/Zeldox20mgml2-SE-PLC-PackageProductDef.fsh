...
* packaging.packaging[=].containedItem.item.reference.reference = "ManufacturedItemDefinition/Zeldox20mgml2-SE-PLC-ManufacturedItemDef01"
...
* packaging.packaging[=].shelfLifeStorage.specialPrecautionsForStorage[=].coding.code = #100000073420
* packaging.packaging[=].shelfLifeStorage.specialPrecautionsForStorage[=].coding.display = "Do not freeze"
* packaging.packaging[=].containedItem.item.reference.reference = "ManufacturedItemDefinition/Zeldox20mgml2-SE-PLC-ManufacturedItemDef02"
* packaging.packaging[=].containedItem.amount.value = 1
