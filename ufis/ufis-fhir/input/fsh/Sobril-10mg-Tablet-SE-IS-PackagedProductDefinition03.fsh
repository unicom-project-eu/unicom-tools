...
* packaging.shelfLifeStorage.periodDuration.value = 18
...
* packaging.packaging.quantity = 49
...
* packaging.packaging.containedItem.item.reference.reference = "ManufacturedItemDefinition/Sobril-10mg-Tablet-SE-IS-ManufacturedItemDefinition"
