...
* packaging.packaging.packaging.containedItem.item.reference.reference = "ManufacturedItemDefinition/Fragmin-15000IE-Solution-SE-IS-ManufacturedItemDefinition"
