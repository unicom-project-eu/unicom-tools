...
* packaging.shelfLifeStorage.periodDuration.value = 36
...
* packaging.packaging.containedItem.item.reference.reference = "ManufacturedItemDefinition/Attentin-10mg-Tablet-SE-AJ-ManufacturedItemDefinition"
