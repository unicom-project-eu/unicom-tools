...
* packaging.packaging.type.coding.code = #100000073523
* packaging.packaging.type.coding.display = "Jar"
...
* packaging.packaging.containedItem.item.reference.reference = "ManufacturedItemDefinition/HermolepsinR-200mg-PRTablet-SE-AJ-ManufacturedItemDefinition"
