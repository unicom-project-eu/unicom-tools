...
* packaging.packaging.packaging.containedItem.item.reference.reference = "ManufacturedItemDefinition/Fragmin-18000IE-Solution-SE-IS-ManufacturedItemDefinition"
