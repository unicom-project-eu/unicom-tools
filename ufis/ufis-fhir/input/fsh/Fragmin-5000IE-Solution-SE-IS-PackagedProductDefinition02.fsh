...
* packaging.packaging.quantity = 100
...
* packaging.packaging.packaging.containedItem.item.reference.reference = "ManufacturedItemDefinition/Fragmin-5000IE-Solution-SE-IS-ManufacturedItemDefinition"
