...
* packaging.packaging.containedItem.item.reference.reference = "ManufacturedItemDefinition/Nobligan100mgmloraladropparlos-SE-PLC-ManufacturedItemDef"
* packaging.packaging.containedItem.amount.value = 96
