Instance: IMAsandoz-400mg-Tablet-SE-IS-PackagedProductDefinition
InstanceOf: PPLPackagedProductDefinition

* containedItemQuantity = 10 http://spor.ema.europa.eu/v1/lists/200000000014#200000002152 "Tablet"
* packageFor = Reference(MedicinalProductDefinitionn/IMAsandoz-400mg-Tablet-SE-IS-MedicinalProductDefinition)
