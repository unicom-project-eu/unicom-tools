...
Usage: #inline
* status = #active
* formOf = Reference(Fragmin-2500IE-Solution-SE-IS-MedicinalProductDefinition)
...
* routeOfAdministration.code.coding[+] = $100000073345#100000075556 "Extracorporeal use"