Instance: Yasminelle28-tablet-SE-AJ-Ingredient02
InstanceOf: Ingredient
Usage: #inline
* status = #active
* for[0] = Reference(Yasminelle28-tablet-SE-AJ-MedicinalProductDefinition)
* for[+] = Reference(Yasminelle28-tablet-SE-AJ-ManufacturedItemDefinition02)
* for[+] = Reference(AdministrableProductDefinitionYasminelle28-tablet-SE-AJ-AdministrableProductDefinition02)
